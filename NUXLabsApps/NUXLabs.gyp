  ...
  'targets': [
    {
      ...
      'link_settings': {
        'mac_bundle_resources': [
          '<!@(find <(DEPTH)/NUXLabs/Resources -name "*.png")',
          '<!@(find <(DEPTH)/NUXLabs/Resources -name "*.jpg")',
          '<!@(find <(DEPTH)/NUXLabs/Resources -name "*.json")',
      ...
      'xcode_settings': {
        'INFOPLIST_FILE': '<(DEPTH)/NUXLabs/SDKDemo-Info.plist',
