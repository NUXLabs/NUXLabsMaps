...
#import "NUXLabs/NUXLabsAPIKey.h"
#import "NUXLabs/NUXLabsMapsMasterViewController.h"
#import <GoogleMaps/GoogleMaps.h>

@implementation NUXLabsMapsAppDelegate {
  id services_;
}
...
- (BOOL)application:(UIApplication *)application
  ...
  if ([kAPIKey length] == 0) {
    ...
    NSString *format = @"API key needs to be configured ";
    @throw [NSException exceptionWithName:@"NUXLabsMapsAppDelegate"
  ...
  NUXLabsMapsMasterViewController *master = [[NUXLabsMapsMasterViewController alloc] init];
